...
#            self.launch_config = 'filesrc location=./music.wav ! decodebin'
...
#                            + '! pocketsphinx hmm=tdt_sc_8kadapt  name=asr ! fakesink'
#                            + '! pocketsphinx  lm=robot.lm.dmp dict=robot.dic name=asr ! fakesink'
